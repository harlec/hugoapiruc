...
$nav = [
    ...
    ['page'=>'padron',    'href'=>'/admin/padron.php',    'icon'=>'M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4', 'label'=>'Padrón RUC'],
];
?>
<style>
:root {
